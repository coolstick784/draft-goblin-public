...
chrome.runtime.onMessage.addListener((message,sender,sendResponse)=>{
  ...
  if(message.type==="OPEN_DRAFT_SIDE_PANEL"||message.type==="ESPN_OPEN_SIDE_PANEL"){
    const tabId=sender.tab?.id;if(!Number.isInteger(tabId)||!draftInfoForUrl(sender.tab?.url)){sendResponse({ok:false,error:"Open an ESPN or Sleeper draft first."});return}
